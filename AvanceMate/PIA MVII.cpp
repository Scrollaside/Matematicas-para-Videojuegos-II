...
int main() {
    ...
    while (opcion != -1) {
        ...
        cout << "6. Rotacion 3D paralela a un eje." << endl;
        cout << "7. Rotar sobre un vector." << endl;
        cout << "8. Trazo de líneas." << endl;
        cout << "9. Trazo de círculos." << endl;
        cout << "10. Trazo de elipses." << endl;
        cout << "11. Salir" << endl;
...
void Trazo_Circulos() {
    system("CLS");
    float pk, x_punto, y_punto, radio, dx, dy, repeticiones, x_res = 0, y_res = 0;

    cout << endl << "Ingrese el valor x del centro: ";
    cin >> x_punto;
    cout << "Ingrese el valor y del centro: ";
    cin >> y_punto;
    ...
    x_res += dx;
    y_res += dy;
    cout << "Centro: (" << x_punto << ", " << y_punto << ")" << endl;
    cout << "Radio: " << radio << endl;
    cout << "Los puntos que conforman el octante son: " << "\n\n(" << dx + x_punto << "," << dy + y_punto << ") | (" << dy + x_punto << "," << dx + y_punto << ")";
    ...
    while (x_res < y_res) {
        if (pk < 0) {
            ...
            pk = pk + 2 * x_res + 3 - (2 * y_res - 2);
            x_res += 1;
            y_res -= 1;
        }
        cout << "\n(" << x_res + x_punto << "," << y_res + y_punto << ") | ";
        if (x_res != y_res) {
            cout << "(" << y_res + x_punto << "," << x_res + y_punto << ")";
        }
    }
...
void RotarSobreVector()
{
    float P1Vx, P1Vy, P1Vz, P2Vx, P2Vy, P2Vz, Angle, Rad;
    float ArregloVector[3], lvl, a, b, c, d, translacion[3];
    float alpha, beta;
    float MC[4][4], TranslacionInversaMatriz[4][4], TranslacionMatriz[4][4], RotacionInversaX[4][4], RotacionInversaY[4][4], RotacionZ[4][4], RotacionX[4][4], RotacionY[4][4];

    system("cls");

    cout << "Escriba el primer punto de su vector: " << endl;
    cout << "x: ";
    cin >> P1Vx;
    cout << "\ny: ";
    cin >> P1Vy;
    ...
    cout << "Escriba el segundo punto de su vector: " << endl;
    cout << "x: ";
    cin >> P2Vx;
    cout << "\ny: ";
    cin >> P2Vy;
    ...
    cout << "\nP1V: (" << P1Vx << " ," << P1Vy << " ," << P1Vz << ")" << endl;
    cout << "\nP2V: (" << P2Vx << " ," << P2Vy << " ," << P2Vz << ")" << endl;

    cout << "\nVector (P2V-P1V): (" << P2Vx - P1Vx << " ," << P2Vy - P1Vy << " ," << P2Vz - P1Vz << ")" << endl;

    cout << "\nIngrese el el angulo a rotar (grados)" << endl;
    cin >> Angle;

    system("cls");

    ArregloVector[0] = P2Vx - P1Vx;
    ArregloVector[1] = P2Vy - P1Vy;
    ArregloVector[2] = P2Vz - P1Vz;

    lvl = sqrt(pow(ArregloVector[0], 2) + pow(ArregloVector[1], 2) + pow(ArregloVector[2], 2));
    /*  cout << lvl << endl;*/

    a = ArregloVector[0] / lvl;
    b = ArregloVector[1] / lvl;
    c = ArregloVector[2] / lvl;

    translacion[0] = P1Vx - (P1Vx * 2);
    translacion[1] = P1Vy - (P1Vy * 2);
    translacion[2] = P1Vz - (P1Vz * 2);

    d = sqrt(pow(b, 2) + pow(c, 2));

    alpha = asin(b / d)/**180/PI*/;
    beta = acos(d / (sqrt(pow(a, 2) + pow(d, 2)))) /** 180 / PI*/ * -1;

    /*cout << alpha << endl;
    cout << beta << endl;*/


    TranslacionInversaMatriz[0][0] = 1, TranslacionInversaMatriz[0][1] = 0, TranslacionInversaMatriz[0][2] = 0, TranslacionInversaMatriz[0][3] = P1Vx;
    TranslacionInversaMatriz[1][0] = 0, TranslacionInversaMatriz[1][1] = 1, TranslacionInversaMatriz[1][2] = 0, TranslacionInversaMatriz[1][3] = P1Vy;
    TranslacionInversaMatriz[2][0] = 0, TranslacionInversaMatriz[2][1] = 0, TranslacionInversaMatriz[2][2] = 1, TranslacionInversaMatriz[2][3] = P1Vz;
    TranslacionInversaMatriz[3][0] = 0, TranslacionInversaMatriz[3][1] = 0, TranslacionInversaMatriz[3][2] = 0, TranslacionInversaMatriz[3][3] = 1;

    for (int i = 0; i < 4; i++)
    {
        for (int j = 0; j < 4; j++)
        {
            MC[i][j] = TranslacionInversaMatriz[i][j];
        }
    }

    RotacionInversaX[0][0] = 1, RotacionInversaX[0][1] = 0, RotacionInversaX[0][2] = 0, RotacionInversaX[0][3] = 0;
    RotacionInversaX[1][0] = 0, RotacionInversaX[1][1] = cos(alpha * -1), RotacionInversaX[1][2] = 0 - sin(alpha * -1), RotacionInversaX[1][3] = 0;
    RotacionInversaX[2][0] = 0, RotacionInversaX[2][1] = sin(alpha * -1), RotacionInversaX[2][2] = cos(alpha * -1), RotacionInversaX[2][3] = 0;
    RotacionInversaX[3][0] = 0, RotacionInversaX[3][1] = 0, RotacionInversaX[3][2] = 0, RotacionInversaX[3][3] = 1;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            for (int k = 0; k < 4; k++)
            {
                result[i][j] += MC[i][k] * RotacionInversaX[k][j];
            }
    ...
    RotacionInversaY[0][0] = cos(beta * -1), RotacionInversaY[0][1] = 0, RotacionInversaY[0][2] = sin(beta * -1), RotacionInversaY[0][3] = 0;
    RotacionInversaY[1][0] = 0, RotacionInversaY[1][1] = 1, RotacionInversaY[1][2] = 0, RotacionInversaY[1][3] = 0;
    RotacionInversaY[2][0] = 0 - sin(beta * -1), RotacionInversaY[2][1] = 0, RotacionInversaY[2][2] = cos(beta * -1), RotacionInversaY[2][3] = 0;
    RotacionInversaY[3][0] = 0, RotacionInversaY[3][1] = 0, RotacionInversaY[3][2] = 0, RotacionInversaY[3][3] = 1;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            for (int k = 0; k < 4; k++)
            {
                result[i][j] += MC[i][k] * RotacionInversaY[k][j];
            }
    ...
    RotacionZ[0][0] = cos(Angle * PI / 180), RotacionZ[0][1] = 0 - sin(Angle * PI / 180), RotacionZ[0][2] = 0, RotacionZ[0][3] = 0;
    RotacionZ[1][0] = sin(Angle * PI / 180), RotacionZ[1][1] = cos(Angle * PI / 180), RotacionZ[1][2] = 0, RotacionZ[1][3] = 0;
    RotacionZ[2][0] = 0, RotacionZ[2][1] = 0, RotacionZ[2][2] = 1, RotacionZ[2][3] = 0;
    RotacionZ[3][0] = 0, RotacionZ[3][1] = 0, RotacionZ[3][2] = 0, RotacionZ[3][3] = 1;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            for (int k = 0; k < 4; k++)
            {
                result[i][j] += MC[i][k] * RotacionZ[k][j];
            }
    ...
    RotacionY[0][0] = cos(beta), RotacionY[0][1] = 0, RotacionY[0][2] = sin(beta), RotacionY[0][3] = 0;
    RotacionY[1][0] = 0, RotacionY[1][1] = 1, RotacionY[1][2] = 0, RotacionY[1][3] = 0;
    RotacionY[2][0] = 0 - sin(beta), RotacionY[2][1] = 0, RotacionY[2][2] = cos(beta), RotacionY[2][3] = 0;
    RotacionY[3][0] = 0, RotacionY[3][1] = 0, RotacionY[3][2] = 0, RotacionY[3][3] = 1;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            for (int k = 0; k < 4; k++)
            {
                result[i][j] += MC[i][k] * RotacionY[k][j];
            }
    ...
    RotacionX[0][0] = 1, RotacionX[0][1] = 0, RotacionX[0][2] = 0, RotacionX[0][3] = 0;
    RotacionX[1][0] = 0, RotacionX[1][1] = cos(alpha), RotacionX[1][2] = 0 - sin(alpha), RotacionX[1][3] = 0;
    RotacionX[2][0] = 0, RotacionX[2][1] = sin(alpha), RotacionX[2][2] = cos(alpha), RotacionX[2][3] = 0;
    RotacionX[3][0] = 0, RotacionX[3][1] = 0, RotacionX[3][2] = 0, RotacionX[3][3] = 1;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            for (int k = 0; k < 4; k++)
            {
                result[i][j] += MC[i][k] * RotacionX[k][j];
            }
    ...
    TranslacionMatriz[0][0] = 1, TranslacionMatriz[0][1] = 0, TranslacionMatriz[0][2] = 0, TranslacionMatriz[0][3] = translacion[0];
    TranslacionMatriz[1][0] = 0, TranslacionMatriz[1][1] = 1, TranslacionMatriz[1][2] = 0, TranslacionMatriz[1][3] = translacion[1];
    TranslacionMatriz[2][0] = 0, TranslacionMatriz[2][1] = 0, TranslacionMatriz[2][2] = 1, TranslacionMatriz[2][3] = translacion[2];
    TranslacionMatriz[3][0] = 0, TranslacionMatriz[3][1] = 0, TranslacionMatriz[3][2] = 0, TranslacionMatriz[3][3] = 1;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            ...
            for (int k = 0; k < 4; k++)
            {
                result[i][j] += MC[i][k] * TranslacionMatriz[k][j];
            }
    ...
    cout << "MatrizCompuesta" << endl;

    cout << "MC = T^-1(" << P1Vx << " ," << P1Vy << " ," << P1Vz << ")*Rx^-1(" << -alpha*180/PI << ")Ry^-1(" << -beta*180/PI << ")*Rz(" << Angle << ")*Ry(" << beta * 180 / PI << ")*"
        << "Rx(" << alpha * 180 / PI << ")*T(" << -P1Vx << " ," << -P1Vy << " ," << -P1Vz << ")\n\n";
    for (int i = 0; i < 4; i++)
    {
        cout << endl;
